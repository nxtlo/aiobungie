URLS = [
    ...
    "aiobungie/internal/factory.html",
...
INDEX = [{
    ...
    },
    {
        ...
        "url": 0,
        "doc": "A property that returns the entity factory for the client."
    },
    {
    ...
    {
        "ref": "aiobungie.Client.fetch_clan_conversations",
        "url": 0,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.Client.fetch_clan_admins",
        "url": 0,
        "doc": "Fetch the clan founder and admins. Parameters      clan_id :  builtins.int The clan id. Returns    -  typing.Sequence[aiobungie.crate.ClanAdmin] A sequence of the found clan admins and founder. Raises     aiobungie.ClanNotFound The requested clan was not found.",
        "func": 1
    },
    {
        "ref": "aiobungie.Client.fetch_groups_for_member",
        "url": 0,
        "doc": "Fetch information about the groups that a given member has joined. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  typing.Optional[aiobungie.crate.clans.GroupMember] The member if found and  None if not.",
        "func": 1
    },
    {
        "ref": "aiobungie.Client.fetch_potential_groups_for_member",
        "url": 0,
        "doc": "",
        "func": 1
    },
    ...
    },
    {
        ...
        "url": 0,
        "doc": "Search for users by their global name and return all users who share this name. Parameters      name :  str The user name. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the found users. Raises     aiobungie.NotFound The user(s) was not found.",
        "func": 1
    },
    {
    ...
    {
        "ref": "aiobungie.RESTClient.fetch_clan_admins",
        "url": 0,
        "doc": "Fetch the admins and founder members of the clan. Parameters      clan_id :  builtins.int The clan id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of the clan admins and founder members. Raises     aiobungie.ClanNotFound The clan was not found.",
        "func": 1
    },
    {
        "ref": "aiobungie.RESTClient.fetch_clan_conversations",
        "url": 0,
        "doc": "Fetch a clan's conversations. Parameters      clan_id :  builtins.int The clan's id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonArray] A JSON array of the conversations.",
        "func": 1
    },
    {
    ...
    {
        "ref": "aiobungie.RESTClient.fetch_groups_for_member",
        "url": 0,
        "doc": "Fetch the information about the groups for a member. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
    {
        "ref": "aiobungie.RESTClient.fetch_potential_groups_for_member",
        "url": 0,
        "doc": "Get information about the groups that a given member has applied to or been invited to. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
    {
        "ref": "aiobungie.RESTClient.fetch_clan_members",
        "url": 0,
        "doc": "Fetch all Bungie Clan members. Parameters      clan_id :  builsins.int The clans id type :  aiobungie.MembershipType An optional clan member's membership type. Default is set to  aiobungie.MembershipType.NONE Which returns the first matched clan member by their name. name :  builtins.str This parameter is only provided here to keep the signature with the main client implementation, Which only works with the non-rest clients. It returns a specific clan member by their name. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of clan members. Raises     aiobungie.ClanNotFound The clan was not found.",
        "func": 1
    },
    {
    ...
    },
    {
        ...
        "url": 0,
        "doc": "Raised when a user was not found."
    },
    {
    ...
    {
        "ref": "aiobungie.ClanMemberType",
        "url": 0,
        "doc": "An enum for bungie clan member types."
    },
    {
        "ref": "aiobungie.ClanMemberType.NONE",
        "url": 0,
        "doc": ""
    },
    {
        "ref": "aiobungie.ClanMemberType.BEGINNER",
        "url": 0,
        "doc": ""
    },
    {
        "ref": "aiobungie.ClanMemberType.MEMBER",
        "url": 0,
        "doc": ""
    },
    {
        "ref": "aiobungie.ClanMemberType.ADMIN",
        "url": 0,
        "doc": ""
    },
    {
        "ref": "aiobungie.ClanMemberType.ACTING_FOUNDER",
        "url": 0,
        "doc": ""
    },
    {
        "ref": "aiobungie.ClanMemberType.FOUNDER",
        "url": 0,
        "doc": ""
    },
    {
    ...
    {
        "ref": "aiobungie.client.Client.fetch_clan_conversations",
        "url": 1,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.client.Client.fetch_clan_admins",
        "url": 1,
        "doc": "Fetch the clan founder and admins. Parameters      clan_id :  builtins.int The clan id. Returns    -  typing.Sequence[aiobungie.crate.ClanAdmin] A sequence of the found clan admins and founder. Raises     aiobungie.ClanNotFound The requested clan was not found.",
        "func": 1
    },
    {
        "ref": "aiobungie.client.Client.fetch_groups_for_member",
        "url": 1,
        "doc": "Fetch information about the groups that a given member has joined. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  typing.Optional[aiobungie.crate.clans.GroupMember] The member if found and  None if not.",
        "func": 1
    },
    {
        "ref": "aiobungie.client.Client.fetch_potential_groups_for_member",
        "url": 1,
        "doc": "",
        "func": 1
    },
    ...
    },
    {
        ...
        "url": 2,
        "doc": "Fetch members who has been banned from the clan.  warning This method is still not implemented. Returns      typing.Sequence[aiobungie.crate.clans.ClanMember] A sequence of clan members or are banned.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.Clan.fetch_pending_members",
        "url": 2,
        "doc": "Fetch members who are waiting to get accepted.  warning This method is still not implemented. Returns      typing.Sequence[aiobungie.crate.clans.ClanMember] A sequence of clan members who are awaiting to get accepted to the clan.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.Clan.fetch_invited_members",
        "url": 2,
        "doc": "Fetch members who has been invited.  warning This method is still not implemented. Returns      typing.Sequence[aiobungie.crate.clans.ClanMember] A sequence of members who have been invited.",
        "func": 1
    },
    {
    ...
    },
    {
        ...
        "url": 2,
        "doc": "The clan owner. This field could be  Undefined if not found."
    },
    {
    ...
    },
    {
        ...
        "url": 2,
        "doc": "The player's unique name.  versionadded 0.2.5"
    },
    {
    ...
    },
    {
        ...
        "url": 2,
        "doc": "Returns  1 if the player has a cross save override in effect and 0 if not.  versionadded 0.2.5"
    },
    {
    ...
    },
    {
        ...
        "url": 3,
        "doc": "Equip an item to this character. This requires the OAuth2: MoveEquipDestinyItems scope. Also You must have a valid Destiny account, and either be in a social space, in orbit or offline.  warning This method is sill not implemented. Parameters      item:  builtins.int The item id you want to equip for this character. Returns    -  builtins.None . Raises     NotImplementedError This endpoint is currently not implemented.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.Character.equip_items",
        "url": 3,
        "doc": "Equip multiple items to this character. This requires the OAuth2: MoveEquipDestinyItems scope. Also You must have a valid Destiny account, and either be in a social space, in orbit or offline.  warning This method is sill not implemented. Parameters      items:  typing.List[builtins.int] A list of item ids you want to equip for this character. Returns    -  builtins.None . Raises     NotImplementedError This endpoint is currently not implemented.",
        "func": 1
    },
    {
    ...
    },
    {
        ...
        "url": 2,
        "doc": "Represents a Bungie clan member. Method generated by attrs for class ClanMember."
    },
    {
        "ref": "aiobungie.crate.ClanMember.unique_name",
        "url": 2,
        "doc": "The clan member's unique name which includes their unique code.  versionadded 0.2.5"
    },
    {
    ...
    },
    {
        ...
        "url": 2,
        "doc": "Bans a clan member from the clan. This requires OAuth2: AdminGroups scope.  warning This method is still not implemented.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.ClanMember.unban",
        "url": 2,
        "doc": "Unbans a clan member clan. This requires OAuth2: AdminGroups scope.  warning This method is still not implemented.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.ClanMember.kick",
        "url": 2,
        "doc": "Kicks a clan member from the clan. The requires OAuth2: AdminsGroup scope.  warning This method is still not implemented.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.ClanMember.bungie",
        "url": 2,
        "doc": "The clan member's bungie partial net user.  note This only returns a partial bungie net user. You can fetch the fully implemented user using  aiobungie.crate.PartialBungieUser.fetch_self() method."
    },
    {
    ...
    {
        "ref": "aiobungie.crate.ApplicationOwner.fetch_self",
        "url": 2,
        "doc": "Fetch the bungie user for this application owner. Returns    -  aiobungie.crate.BungieUser A Bungie net user. Raises     aiobungie.UserNotFound The user was not found.  versionadded 0.2.5",
        "func": 1
    },
    {
    ...
    {
        "ref": "aiobungie.crate.DestinyUser.fetch_self_profile",
        "url": 2,
        "doc": "Fetch the player's profile. Returns    -  aiobungie.crate.Profile The profile of this membership.",
        "func": 1
    },
    {
    ...
    {
        "ref": "aiobungie.crate.DestinyUser.net",
        "url": 2,
        "doc": "A network state used for making external requests."
    },
    {
    ...
    {
        "ref": "aiobungie.crate.ClanAdmin",
        "url": 2,
        "doc": "Represents a clan admin. Method generated by attrs for class ClanAdmin."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.fetch_clan",
        "url": 2,
        "doc": "Fetch the clan that represents the clan admins. Returns    -  Clan The clan admins clan.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.unique_name",
        "url": 2,
        "doc": "The admin's unique name which includes their unique code.  versionadded 0.2.5"
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.link",
        "url": 2,
        "doc": "Clan member's profile link."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.bungie",
        "url": 2,
        "doc": "The clan admin's bungie partial net user.  note This only returns a partial bungie net user. You can fetch the fully implemented user using  aiobungie.crate.PartialBungieUser.fetch_self() method."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.code",
        "url": 2,
        "doc": "The clan admin's bungie display name code This is new and was added in Season of the lost update  versionadded 0.2.5"
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.group_id",
        "url": 2,
        "doc": "The admin's group or clan id."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.icon",
        "url": 2,
        "doc": "Clan admin's icon"
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.id",
        "url": 2,
        "doc": "Clan admin's id"
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.is_online",
        "url": 2,
        "doc": "True if the clan admin is online or not."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.is_public",
        "url": 2,
        "doc": " builtins.True if the clan admin is public."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.joined_at",
        "url": 2,
        "doc": "The clan admin's join date in UTC time zone."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.last_online",
        "url": 2,
        "doc": "The date of the clan admin's last online in UTC time zone."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.last_seen_name",
        "url": 2,
        "doc": "The clan admin's last seen display name"
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.member_type",
        "url": 2,
        "doc": "The clan admin's member type. This can be Admin or owner or any other type.  versionadded 0.2.5"
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.name",
        "url": 2,
        "doc": "Clan admin's name. This can be  UNDEFINED if not found."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.net",
        "url": 2,
        "doc": "A network state used for making external requests."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.total_admins",
        "url": 2,
        "doc": "The total count of the clan admins."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.type",
        "url": 2,
        "doc": "Clan admin's membership type."
    },
    {
        "ref": "aiobungie.crate.ClanAdmin.types",
        "url": 2,
        "doc": "A sequence of the available clan admin membership types."
    },
    {
        "ref": "aiobungie.crate.GroupMember",
        "url": 2,
        "doc": "Represents information about joined groups/clans for a member. Method generated by attrs for class GroupMember."
    },
    {
        "ref": "aiobungie.crate.GroupMember.fetch_self_clan",
        "url": 2,
        "doc": "Fetch an up-todate clan/group object of the current group. Returns    -  Clan The clan object.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.GroupMember.group",
        "url": 2,
        "doc": "The member's group/clan object that represents the group member."
    },
    {
        "ref": "aiobungie.crate.GroupMember.group_id",
        "url": 2,
        "doc": "The group id of this member."
    },
    {
        "ref": "aiobungie.crate.GroupMember.inactive_memberships",
        "url": 2,
        "doc": "The member's inactive memberships if provided. This will be  None if not provided."
    },
    {
        "ref": "aiobungie.crate.GroupMember.is_online",
        "url": 2,
        "doc": "Whether the member is online or not."
    },
    {
        "ref": "aiobungie.crate.GroupMember.join_date",
        "url": 2,
        "doc": "An awre UTC datetime of the member's join date."
    },
    {
        "ref": "aiobungie.crate.GroupMember.last_online",
        "url": 2,
        "doc": "An awre UTC datetime of the member's last online status."
    },
    {
        "ref": "aiobungie.crate.GroupMember.member",
        "url": 2,
        "doc": "The member's destiny object that represents the group member."
    },
    {
        "ref": "aiobungie.crate.GroupMember.member_type",
        "url": 2,
        "doc": "The member's member type."
    },
    {
        "ref": "aiobungie.crate.GroupMember.net",
        "url": 2,
        "doc": "Return an attribute of instance, which is of type owner."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser",
        "url": 2,
        "doc": "Represents partial bungie user. This is usually used for bungie users that are missing attributes not present in  BungieUser , i.e., Clan members, Owners, Moderators and any other object the has a  bungie attribute.  note You can fetch the actual bungie user of this partial user by using  PartialBungieUser.fetch_self() method.  versionadded 0.2.5 Method generated by attrs for class PartialBungieUser."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.fetch_self",
        "url": 2,
        "doc": "Fetch the Bungie user of this partial user. Returns    -  aiobungie.crate.BungieUser A Bungie net user. Raises     aiobungie.UserNotFound The user was not found.  versionadded 0.2.5",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.crossave_override",
        "url": 2,
        "doc": "The user's crossave override membership."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.icon",
        "url": 2,
        "doc": "The user's icon."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.id",
        "url": 2,
        "doc": "The user's id."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.is_public",
        "url": 2,
        "doc": "The user's privacy."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.name",
        "url": 2,
        "doc": "The user's name. Field may be undefined if not found."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.net",
        "url": 2,
        "doc": "A network state used for making external requests."
    },
    {
        "ref": "aiobungie.crate.PartialBungieUser.type",
        "url": 2,
    ...
    {
        "ref": "aiobungie.crate.application.ApplicationOwner.fetch_self",
        "url": 7,
        "doc": "Fetch the bungie user for this application owner. Returns    -  aiobungie.crate.BungieUser A Bungie net user. Raises     aiobungie.UserNotFound The user was not found.  versionadded 0.2.5",
        "func": 1
    },
    ...
    {
        "ref": "aiobungie.crate.clans.ClanMember.bungie",
        "url": 8,
        "doc": "The clan member's bungie partial net user.  note This only returns a partial bungie net user. You can fetch the fully implemented user using  aiobungie.crate.PartialBungieUser.fetch_self() method."
    },
    {
    ...
    {
        "ref": "aiobungie.crate.clans.ClanAdmin",
        "url": 8,
        "doc": "Represents a clan admin. Method generated by attrs for class ClanAdmin."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.fetch_clan",
        "url": 8,
        "doc": "Fetch the clan that represents the clan admins. Returns    -  Clan The clan admins clan.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.unique_name",
        "url": 8,
        "doc": "The admin's unique name which includes their unique code.  versionadded 0.2.5"
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.link",
        "url": 8,
        "doc": "Clan member's profile link."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.bungie",
        "url": 8,
        "doc": "The clan admin's bungie partial net user.  note This only returns a partial bungie net user. You can fetch the fully implemented user using  aiobungie.crate.PartialBungieUser.fetch_self() method."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.code",
        "url": 8,
        "doc": "The clan admin's bungie display name code This is new and was added in Season of the lost update  versionadded 0.2.5"
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.group_id",
        "url": 8,
        "doc": "The admin's group or clan id."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.icon",
        "url": 8,
        "doc": "Clan admin's icon"
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.id",
        "url": 8,
        "doc": "Clan admin's id"
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.is_online",
        "url": 8,
        "doc": "True if the clan admin is online or not."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.is_public",
        "url": 8,
        "doc": " builtins.True if the clan admin is public."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.joined_at",
        "url": 8,
        "doc": "The clan admin's join date in UTC time zone."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.last_online",
        "url": 8,
        "doc": "The date of the clan admin's last online in UTC time zone."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.last_seen_name",
        "url": 8,
        "doc": "The clan admin's last seen display name"
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.member_type",
        "url": 8,
        "doc": "The clan admin's member type. This can be Admin or owner or any other type.  versionadded 0.2.5"
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.name",
        "url": 8,
        "doc": "Clan admin's name. This can be  UNDEFINED if not found."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.net",
        "url": 8,
        "doc": "A network state used for making external requests."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.total_admins",
        "url": 8,
        "doc": "The total count of the clan admins."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.type",
        "url": 8,
        "doc": "Clan admin's membership type."
    },
    {
        "ref": "aiobungie.crate.clans.ClanAdmin.types",
        "url": 8,
        "doc": "A sequence of the available clan admin membership types."
    },
    {
    ...
    {
        "ref": "aiobungie.crate.clans.ClanConversation",
        "url": 8,
        "doc": "Represents a clan conversation. Method generated by attrs for class ClanConversation."
    },
    {
        "ref": "aiobungie.crate.clans.ClanConversation.chat_enabled",
        "url": 8,
        "doc": " True if the Conversation's chat is enabled."
    },
    {
        "ref": "aiobungie.crate.clans.ClanConversation.group_id",
        "url": 8,
        "doc": "The clan or group's id."
    },
    {
        "ref": "aiobungie.crate.clans.ClanConversation.id",
        "url": 8,
        "doc": "The conversation's id"
    },
    {
        "ref": "aiobungie.crate.clans.ClanConversation.name",
        "url": 8,
        "doc": "Conversation chat's name."
    },
    {
        "ref": "aiobungie.crate.clans.ClanConversation.security",
        "url": 8,
        "doc": "Conversation's security level."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember",
        "url": 8,
        "doc": "Represents information about joined groups/clans for a member. Method generated by attrs for class GroupMember."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.fetch_self_clan",
        "url": 8,
        "doc": "Fetch an up-todate clan/group object of the current group. Returns    -  Clan The clan object.",
        "func": 1
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.group",
        "url": 8,
        "doc": "The member's group/clan object that represents the group member."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.group_id",
        "url": 8,
        "doc": "The group id of this member."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.inactive_memberships",
        "url": 8,
        "doc": "The member's inactive memberships if provided. This will be  None if not provided."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.is_online",
        "url": 8,
        "doc": "Whether the member is online or not."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.join_date",
        "url": 8,
        "doc": "An awre UTC datetime of the member's join date."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.last_online",
        "url": 8,
        "doc": "An awre UTC datetime of the member's last online status."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.member",
        "url": 8,
        "doc": "The member's destiny object that represents the group member."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.member_type",
        "url": 8,
        "doc": "The member's member type."
    },
    {
        "ref": "aiobungie.crate.clans.GroupMember.net",
        "url": 8,
        "doc": "Return an attribute of instance, which is of type owner."
    },
    {
    ...
    {
        "ref": "aiobungie.crate.user.PartialBungieUser.fetch_self",
        "url": 5,
        "doc": "Fetch the Bungie user of this partial user. Returns    -  aiobungie.crate.BungieUser A Bungie net user. Raises     aiobungie.UserNotFound The user was not found.  versionadded 0.2.5",
        "func": 1
    },
    ...
    {
        "ref": "aiobungie.crate.user.PartialBungieUser.net",
        "url": 5,
        "doc": "A network state used for making external requests."
    },
    {
    ...
    {
        "ref": "aiobungie.crate.user.DestinyUser.fetch_self_profile",
        "url": 5,
        "doc": "Fetch the player's profile. Returns    -  aiobungie.crate.Profile The profile of this membership.",
        "func": 1
    },
    ...
    {
        "ref": "aiobungie.crate.user.DestinyUser.net",
        "url": 5,
        "doc": "A network state used for making external requests."
    },
    {
    ...
    {
        "ref": "aiobungie.interfaces.RESTInterface.fetch_clan_conversations",
        "url": 16,
        "doc": "Fetch a clan's conversations. Parameters      clan_id :  builtins.int The clan's id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonArray] A JSON array of the conversations.",
        "func": 1
    },
    {
        "ref": "aiobungie.interfaces.RESTInterface.fetch_clan_admins",
        "url": 16,
        "doc": "Fetch the admins and founder members of the clan. Parameters      clan_id :  builtins.int The clan id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of the clan admins and founder members. Raises     aiobungie.ClanNotFound The clan was not found.",
        "func": 1
    },
    {
        "ref": "aiobungie.interfaces.RESTInterface.fetch_groups_for_member",
        "url": 16,
        "doc": "Fetch the information about the groups for a member. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
    {
        "ref": "aiobungie.interfaces.RESTInterface.fetch_potential_groups_for_member",
        "url": 16,
        "doc": "Get information about the groups that a given member has applied to or been invited to. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
    ...
    {
        "ref": "aiobungie.interfaces.rest.RESTInterface.fetch_clan_conversations",
        "url": 17,
        "doc": "Fetch a clan's conversations. Parameters      clan_id :  builtins.int The clan's id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonArray] A JSON array of the conversations.",
        "func": 1
    },
    {
        "ref": "aiobungie.interfaces.rest.RESTInterface.fetch_clan_admins",
        "url": 17,
        "doc": "Fetch the admins and founder members of the clan. Parameters      clan_id :  builtins.int The clan id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of the clan admins and founder members. Raises     aiobungie.ClanNotFound The clan was not found.",
        "func": 1
    },
    {
        "ref": "aiobungie.interfaces.rest.RESTInterface.fetch_groups_for_member",
        "url": 17,
        "doc": "Fetch the information about the groups for a member. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
    {
        "ref": "aiobungie.interfaces.rest.RESTInterface.fetch_potential_groups_for_member",
        "url": 17,
        "doc": "Get information about the groups that a given member has applied to or been invited to. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
    ...
    {
        "ref": "aiobungie.internal.factory",
        "url": 21,
        "doc": "Deserialization for all bungie incoming json payloads."
    },
    {
        "ref": "aiobungie.internal.factory.Factory",
        "url": 21,
        "doc": "The base Deserialization factory class for all aiobungie objects."
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_bungie_user",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_partial_bungie_user",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_destiny_user",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_destiny_members",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_user",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deseialize_found_users",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.set_themese_attrs",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_user_themes",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_player",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deseialize_clan_owner",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_clan",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_group_member",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_clan_admins",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_clan_member",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_clan_convos",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_clan_members",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_app_owner",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_app",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_character",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_profile",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_inventory_entity",
        "url": 21,
        "doc": "",
        "func": 1
    },
    {
        "ref": "aiobungie.internal.factory.Factory.deserialize_activity",
        "url": 21,
        "doc": "",
        "func": 1
    },
    ...
    {
        "ref": "aiobungie.rest.RESTClient.fetch_clan_admins",
        "url": 25,
        "doc": "Fetch the admins and founder members of the clan. Parameters      clan_id :  builtins.int The clan id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of the clan admins and founder members. Raises     aiobungie.ClanNotFound The clan was not found.",
        "func": 1
    },
    {
        "ref": "aiobungie.rest.RESTClient.fetch_clan_conversations",
        "url": 25,
        "doc": "Fetch a clan's conversations. Parameters      clan_id :  builtins.int The clan's id. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonArray] A JSON array of the conversations.",
        "func": 1
    },
    ...
    {
        "ref": "aiobungie.rest.RESTClient.fetch_groups_for_member",
        "url": 25,
        "doc": "Fetch the information about the groups for a member. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
    {
        "ref": "aiobungie.rest.RESTClient.fetch_potential_groups_for_member",
        "url": 25,
        "doc": "Get information about the groups that a given member has applied to or been invited to. Parameters      member_id :  builtins.int The member's id member_type :  aiobungie.MembershipType The member's membership type. Other Parameters         filter :  builsins.int Filter apply to list of joined groups. This Default to  0 group_type :  aiobungie.GroupType The group's type. This is always set to  aiobungie.GroupType.CLAN and should not be changed. Returns    -  ResponseSig[aiobungie.internal.helpers.JsonObject] A JSON object of an array of the member's membership data and groups data.",
        "func": 1
    },
