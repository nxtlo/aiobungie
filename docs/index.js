...
"url":0,
"doc":"Fetches a post activity details.  ! warning This http request is not implemented yet and it will raise  NotImplementedError Parameters      instance:  builtins.int The activity instance id. Returns    -  aiobungie.crate.activity.PostActivity Information about the requested post activity.",
"func":1
},
{
"ref":"aiobungie.Client.fetch_clan_from_id",
"url":0,
"doc":"Fetches a Bungie Clan by its id. Parameters      - id:  builtins.int The clan id. Returns      aiobungie.crate.Clan An Bungie clan. Raises     aiobungie.ClanNotFound The clan was not found.",
"func":1
},
{
...
"url":0,
"doc":"Fetches a static inventory item entity given a its hash. Parameters      type:  builtins.str Entity's type definition. hash:  builtins.int Entity's hash. Returns    -  aiobungie.crate.InventoryEntity A bungie inventory item.",
"func":1
},
{
"ref":"aiobungie.Client.fetch_app",
"url":0,
"doc":"Fetches a Bungie Application. Parameters      - appid:  builtins.int The application id. Returns      aiobungie.crate.Application A Bungie application.",
"func":1
},
{
...
"url":2,
"doc":"Fetch the members of the clan. if the memberhship type is None it will All membership types. Parameters      type:  aiobungie.MembershipType Filters the membership types to return. Default is 0 which returns all membership types. Returns      typing.Sequence[ClanMember] A sequence of the clan members found in this clan. Raises     aiobungie.ClanNotFound The clan was not found.",
"func":1
},
{
...
{
"ref":"aiobungie.crate.CharacterComponent.member_id",
"url":2,
...
{
"ref":"aiobungie.crate.ProfileComponentImpl.net",
"url":2,
"doc":"A network state used for making external requests."
},
{
...
"url":2,
"doc":"An interface of a Bungie Definition Entity. This is the main entity which all other entities should inherit from. it holds core information that all bungie entities has. Method generated by attrs for class Entity."
},
{
...
{
"ref":"aiobungie.crate.profile.ProfileComponentImpl.net",
"url":5,
"doc":"A network state used for making external requests."
},
{
